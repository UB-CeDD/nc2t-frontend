    ...
    return (
        <MainLayout>
            <div className="text-center">
                ...
                <p className="mt-4 mb-8 text-gray-600">We are sorry, but our application has encountered an error.</p>
                <div className="flex justify-center gap-4">
                    <button onClick={handleReload} className="px-8 py-3 font-semibold rounded bg-red-500 text-gray-50 hover:bg-red-600">Reload Page</button>
