...
const API_BASE_URL = import.meta.env.VITE_API_URL || import.meta.env.API_URL || "http://localhost/api"; // Prefer VITE_API_URL for Vite; fallback to API_URL if present
