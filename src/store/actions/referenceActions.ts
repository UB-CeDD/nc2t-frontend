...
export const CREATE_REFERENCE_REQUEST = 'CREATE_REFERENCE_REQUEST';
...
export const createReferenceRequest = () => ({
    type: CREATE_REFERENCE_REQUEST,
});
...
export const updateReferenceRequest = () => ({
